...
import { transportData, options, setTraceId, triggerHandlers, ReplaceHandler, subscribeEvent } from '../../core/src/index'
import { EMethods, MITOHttp, MITOXMLHttpRequest } from '../../types/src/index'
import { voidFun, EVENTTYPES, HTTPTYPE, HTTP_CODE } from '../../shared/src/index'
  ...
  replaceOld(originalXhrProto, 'send', (originalSend: voidFun): voidFun => {
    return function (this: MITOXMLHttpRequest, ...args: any[]): void {
      ...
      on(this, 'loadend', function (this: MITOXMLHttpRequest) {
        ...
        const eTime = getTimestamp()
        this.mito_xhr.creationDate = this.mito_xhr.sTime
